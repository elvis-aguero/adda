...
_BACKENDS: dict[str, tuple[str, str]] = {
    "claude": ("adda._src.backends.claude", "ClaudeAdapter"),
    "ollama": ("adda._src.backends.ollama", "OllamaAdapter"),
    "openrouter": (
        "adda._src.backends.openrouter", "OpenRouterAdapter"),
    "vllm": ("adda._src.backends.vllm", "VLLMAdapter"),
}
